...
import TractorImage from '../../../../../public/assets/tractorImages/3.webp';

export default function UpcomingTractor({ item, ...other }) {
  ...
  const renderLabels = (
    ...
    >
      <Label variant="soft">
        <Iconify icon="mage:electricity-fill" width={16} height={16} sx={{ mr: 0.5 }} /> 60 HP
      </Label>
